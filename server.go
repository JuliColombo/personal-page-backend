...
func getEducation(w http.ResponseWriter, request *http.Request) {
...
func getJobs(w http.ResponseWriter, request *http.Request) {
	w.Header().Set("Content-Type", "application/json; charset=UTF-8")
	w.Header().Set("Access-Control-Allow-Origin", "*")
	w.WriteHeader(http.StatusOK)
...
func main() {
	http.HandleFunc("/education/", getEducation)
